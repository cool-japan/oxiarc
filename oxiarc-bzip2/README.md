...
**Version 0.2.4** (2026-03-11) — 37 tests passing (2 skipped: heavy/long-running).

**What's new in 0.2.4**: SA-IS correctness fix in the Burrows-Wheeler Transform implementation for improved BWT accuracy on pathological inputs.
...
```toml
[dependencies]
oxiarc-bzip2 = { version = "0.2.4", features = ["parallel"] }
```
