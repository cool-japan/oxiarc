...
oxiarc-archive = { version = "0.4.0", features = ["mmap"] }

# With async ZIP support
oxiarc-archive = { version = "0.4.0", features = ["async-io"] }

# With all features
oxiarc-archive = { version = "0.4.0", features = ["mmap", "async-io"] }
```
