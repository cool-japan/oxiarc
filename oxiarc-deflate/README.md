...
**Version 0.3.4** (2026-06-06) — 212 tests passing.
...
```toml
[dependencies]
oxiarc-deflate = { version = "0.3.4", features = ["async-io"] }
```
...
```toml
[dependencies]
oxiarc-deflate = { version = "0.3.4", features = ["parallel"] }
```
